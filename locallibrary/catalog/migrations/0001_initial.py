# Generated by Django 4.2.13 on 2024-05-09 13:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isbn', models.CharField(help_text='13 charcater <a href="https://www.isbn-international.org/content/what-isbn">ISBN number </a>', max_length=13, unique=True, verbose_name='ISBN')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Enter a book genre (e.g. Fantasy, Sci-Fi, Horror)', max_length=200, unique=True)),
            ],
        ),
